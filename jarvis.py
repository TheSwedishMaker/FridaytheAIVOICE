...
def speak_text(text):
    response = polly_client.synthesize_speech(
        Text=text,
        OutputFormat='mp3',
        VoiceId='Matthew',  # You can use different voice IDs
        Engine="neural" # this uses the neural engine - block out if you dont want that.
    )
    ...
    pygame.mixer.music.set_volume(0.9)  # 0.0 is silent, 1.0 is full volume
...
conversation = []
conversation.append({'role': 'user', 'content': 'you are the friendly AI assistant called Friday from the movie Iron Man'})
